package com.iconium.vinema;

import com.iconium.vinema.R;
...
public class VideoPage extends TabActivity implements OnTabChangeListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		tab1.setContent(new Intent(this,RegisterPage.class));
		tab2.setContent(new Intent(this,RegisterPage.class));
		tab3.setContent(new Intent(this,RegisterPage.class));
